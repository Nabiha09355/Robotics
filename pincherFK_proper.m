function [x, y, z, R] = pincherFK_proper(jointAngles)
    ...
    %
    % Inputs:
    %   jointAngles - 1x4 vector of DH joint angles [th1, th2, th3, th4] in radians [cite: 1073, 1076]
    %
    % Outputs:
    ...
    % Using alpha values from your assignment: [90, 0, 0, 0]
    ...
    % Multiplied in order from base to end-effector [cite: 1057]
    T04 = T01 * T12 * T23 * T34;
    ...
    y = T04(2,4);
    z = T04(3,4);
    R = T04(1:3, 1:3); % Rotation matrix is the top-left 3x3 sub-matrix [cite: 1066]
end