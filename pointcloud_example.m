function pointcloud_example()
    ...
    pcwrite(ptCloud, "pointcloud1.pcd")
    save( "mpointcloud1", "ptCloud")
...
pcwrite(croppedCloud, "croppedcloud2.pcd")
save( "mcropcloud2", "croppedCloud")
...
pcwrite(croppedCloud, "croppedcloud3.pcd")
save( "mcropcloud3", "croppedCloud")
